...
## Analyzing our Facebook  and Facebook ad campaign data 

Now we can analyze our Facaebook Ads data. For instance, let's compare the two campaings we have to see which one performed better the last 100 days. 
